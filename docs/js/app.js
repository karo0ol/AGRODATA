...
const appState = {
  ...
  clients: [
    { nombre: "Finca La Esperanza", nit: "900.221.884-2", ubic: "Ibagué, Tolima", tipo: "Finca productora", cultivo: "Maíz", estado: "Activo", contacto: "Roberto Gómez", tel: "+57 315 402 8877", email: "roberto@esperanza.com", stage: "Venta Pactada", valAnual: "$24.6M", lastBuy: "12 jul 2026", distribuidor: "Camila Ríos", img: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=160&fit=crop", compromisos: [] },
    { nombre: "Agroindustrias El Roble", nit: "800.114.220-9", ubic: "Pitalito, Huila", tipo: "Empresa agroindustrial", cultivo: "Café", estado: "En riesgo", contacto: "Elena Vargas", tel: "+57 310 998 1122", email: "elena@elroble.com", stage: "Interesado", valAnual: "$18.2M", lastBuy: "05 may 2026", distribuidor: "Laura Gómez", img: "https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=160&fit=crop", compromisos: [] },
    { nombre: "Hacienda Santa Rita", nit: "901.556.774-1", ubic: "Yopal, Casanare", tipo: "Finca productora", cultivo: "Arroz", estado: "Activo", contacto: "Hernán Cortés", tel: "+57 320 445 6677", email: "hernan@santarita.com", stage: "Interesado", valAnual: "$32.0M", lastBuy: "28 jun 2026", distribuidor: "Laura Gómez", img: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=160&fit=crop", compromisos: [] },
    { nombre: "Finca El Paraíso", nit: "902.774.310-5", ubic: "Duitama, Boyacá", tipo: "Finca productora", cultivo: "Papa", estado: "Inactivo", contacto: "Jorge Restrepo", tel: "+57 311 223 3445", email: "jorge@paraiso.com", stage: "Prospecto", valAnual: "$12.0M", lastBuy: "14 ene 2026", distribuidor: "Camila Ríos", img: "https://images.unsplash.com/photo-1560493676-04071c5f467b?w=160&fit=crop", compromisos: [] },
    { nombre: "Cultivos del Cauca S.A.S.", nit: "890.221.774-8", ubic: "Santander de Quilichao, Cauca", tipo: "Cooperativa", cultivo: "Caña", estado: "Activo", contacto: "Martha Lucía", tel: "+57 300 778 9900", email: "martha@cultivoscauca.com", stage: "Propuesta", valAnual: "$45.5M", lastBuy: "02 ago 2026", distribuidor: "Laura Gómez", img: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=160&fit=crop", compromisos: [] },
    { nombre: "Finca Buenavista", nit: "903.442.110-3", ubic: "Barrancabermeja, Santander", tipo: "Finca productora", cultivo: "Cacao", estado: "En riesgo", contacto: "Carlos Páez", tel: "+57 318 665 4433", email: "carlos@buenavista.com", stage: "Prospecto", valAnual: "$15.8M", lastBuy: "10 feb 2026", distribuidor: "Camila Ríos", img: "https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=160&fit=crop", compromisos: [] },
    { nombre: "Agropecuaria San José", nit: "800.998.221-4", ubic: "Andes, Antioquia", tipo: "Distribuidor agro", cultivo: "Aguacate", estado: "Activo", contacto: "Sonia Morales", tel: "+57 312 334 5566", email: "sonia@sanjose.com", stage: "Contactado", valAnual: "$28.0M", lastBuy: "18 jul 2026", distribuidor: "Laura Gómez", img: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=160&fit=crop", compromisos: [] },
    { nombre: "Finca Villa Marina", nit: "901.220.667-0", ubic: "Villavicencio, Meta", tipo: "Finca productora", cultivo: "Maíz", estado: "En riesgo", contacto: "Guillermo León", tel: "+57 314 556 7788", email: "guillermo@villamarina.com", stage: "Prospecto", valAnual: "$19.4M", lastBuy: "22 mar 2026", distribuidor: "Camila Ríos", img: "https://images.unsplash.com/photo-1560493676-04071c5f467b?w=160&fit=crop", compromisos: [] }
  ],
  ...
  /* SYS-FR-002: el administrador no tiene zona geográfica (alcance técnico/nacional).
     Cada usuario lleva su "rol" para que el panel del gerente (SYS-FR-025/026) y el
     listado de distribuidores muestren solo distribuidores, y no mezclen ahí las
     cuentas de gerente o administrador, que no tienen clientes/visitas/ventas propias. */
  usersList: [
    { nombre: "Andrés Peña", rol: "administrador", zona: "Nacional", clientes: null, visitas: null, acceso: "Hoy, 8:32 a.m.", estado: "Activo", oportunidades: null, ventas: null },
    { nombre: "Marcela Duarte", rol: "gerente", zona: "Nacional", clientes: null, visitas: null, acceso: "Hoy, 9:05 a.m.", estado: "Activo", oportunidades: null, ventas: null },
    { nombre: "Laura Gómez", rol: "distribuidor", zona: "Huila", clientes: 28, visitas: 11, acceso: "Ayer, 5:10 p.m.", estado: "Activo", oportunidades: 7, ventas: 3 },
    { nombre: "Camila Ríos", rol: "distribuidor", zona: "Boyacá", clientes: 24, visitas: 9, acceso: "Hoy, 7:58 a.m.", estado: "Activo", oportunidades: 6, ventas: 4 }
  ],
  ...
  orders: [
    { id: 5001, clientName: "Finca La Esperanza", distribuidor: "Camila Ríos", producto: "Fertilizante NPK 15-15-15", cantidad: "40 bultos", precio: "$8.5M", fechaEntrega: "2026-08-20", estado: "En proceso", novedades: [] },
    { id: 5002, clientName: "Cultivos del Cauca S.A.S.", distribuidor: "Laura Gómez", producto: "Foliar Nutricional Premium", cantidad: "120 L", precio: "$4.2M", fechaEntrega: "2026-08-10", estado: "Entregada", novedades: [] },
    { id: 5003, clientName: "Finca El Paraíso", distribuidor: "Camila Ríos", producto: "Fungicida Sistémico", cantidad: "25 L", precio: "$2.1M", fechaEntrega: "2026-07-28", estado: "Con novedad", novedades: [ { fecha: "2026-07-29", detalle: "Entrega parcial: faltaron 5 L por desabasto del proveedor." } ] }
  ]
};

const permisosPorRol = {
  asesor: ["Ver y registrar clientes propios", "Gestionar pipeline asignado", "Agendar e informar visitas", "Ver alertas de cartera personal", "Importar base de clientes desde ISA"],
  gerente: ["Dashboard de métricas y desempeño comercial", "Visualización de la totalidad de clientes de todos los distribuidores (solo lectura)", "Reportes comparativos y consolidados", "Alertas globales del sistema", "Supervisión de órdenes de compra", "Importar base de clientes desde ISA"],
  administrador: ["Gestión de usuarios y asignación de roles", "Restablecimiento forzado de contraseñas", "Activación / desactivación de cuentas"]
};

/* SYS-FR-025 / SYS-FR-026 / SYS-FR-028 (módulo M7 "Reportes y panel gerencial" según la
   Ficha Técnica): el gerente supervisa (dashboard, reportes comparativos, alertas globales)
   e importa la base de clientes desde ISA, junto con el distribuidor que es quien gestiona
   esos clientes en campo. Ninguno de los dos gestiona usuarios ni restablece contraseñas.
   SYS-FR-001 / SYS-FR-002 / SYS-FR-003: el administrador gestiona usuarios, roles y
   restablecimientos forzados; no maneja clientes ni datos de ISA. */
const menus = {
  asesor: [
  ...
  gerente: [
    { label: "SUPERVISIÓN GERENCIAL", items: [
      { id: "scr-dashboard-gerente", label: "Panel de Control", icon: "layout-dashboard" },
      { id: "scr-clientes-buscar", label: "Todos los Clientes", icon: "users" },
      { id: "scr-ordenes", label: "Órdenes de Compra", icon: "package-check" },
      { id: "scr-alertas-globales", label: "Alertas Globales", icon: "bell-ring" },
      { id: "scr-reportes-gerente", label: "Reportes Comparativos", icon: "bar-chart-3" },
      { id: "scr-importar-isa", label: "Importar ISA", icon: "upload" }
    ]}
  ],
  administrador: [
    { label: "ADMINISTRACIÓN DEL SISTEMA", items: [
      { id: "scr-usuarios", label: "Usuarios y Roles", icon: "user-cog" }
    ]}
  ]
};

/* Pantalla de inicio de cada rol, y qué pantallas puede ver cada uno (para
   la navegación por URL directa además del menú lateral). */
const ROLE_HOME = { asesor: 'dashboard.html', gerente: 'dashboard.html', administrador: 'usuarios.html' };
const EXTRA_ALLOWED_SCREENS = { asesor: ['scr-ficha-cliente'], gerente: [], administrador: ['scr-usuarios-nuevo'] };

function allowedScreensForRole(role) {
  const ids = [];
  (menus[role] || []).forEach(group => group.items.forEach(item => {
    ids.push(item.id);
    if (item.sub) item.sub.forEach(s => ids.push(s.id));
  }));
  return ids.concat(EXTRA_ALLOWED_SCREENS[role] || []);
}

/* SYS-FR-007: el distribuidor ve solo sus propios clientes; el gerente ve la totalidad
   de clientes de todos los distribuidores, pero en modo consulta (no crea, edita ni
   agenda visitas desde aquí — esas acciones siguen siendo exclusivas del distribuidor). */
function applyClientesRoleView() {
  const role = appState.currentUser ? appState.currentUser.role : 'asesor';
  const actions = document.getElementById('client-buscar-actions');
  const subtitle = document.getElementById('client-buscar-subtitle');
  const isGerente = role === 'gerente';
  if (actions) actions.style.display = isGerente ? 'none' : 'flex';
  if (subtitle) subtitle.textContent = isGerente
    ? 'Vista consolidada de solo lectura: totalidad de clientes de todos los distribuidores'
    : 'Gestiona la relación comercial con tus fincas y empresas del sector agro';
}
...
const SCREEN_PAGE_MAP = {
  ...
  'scr-reportes-gerente': 'reportes.html',
...
function showLoginScreen() {
  ...
  // Reinicia el asistente de recuperación para que la próxima vez empiece en el paso 1
  ['forgot-step2', 'forgot-step3', 'forgot-step4'].forEach(id => {
...
function initPage(defaultScreen, adminScreen) {
  ...
  // Control de acceso: si ninguna de las pantallas de esta página le
  // corresponde al rol actual (ej. un administrador entrando a dashboard.html,
  // o un gerente entrando a usuarios.html), lo mandamos a su pantalla de inicio.
  const pageScreens = [defaultScreen, adminScreen].filter(Boolean);
  const hasAccess = pageScreens.some(s => allowed.includes(s));
  if (!hasAccess) {
  ...
  const roleScreen = (adminScreen && allowed.includes(adminScreen)) ? adminScreen : defaultScreen;
  const pending = sessionStorage.getItem('agrodata_target_screen');
  sessionStorage.removeItem('agrodata_target_screen');
  const target = (pending && allowed.includes(pending) && document.getElementById(pending)) ? pending : roleScreen;
  showScreen(target);
...
/* Simula que el usuario dio clic en el enlace de un solo uso que llegó al correo
   (paso 3 y 4 del restablecimiento: SYS-FR-003). En un sistema real, ese enlace
   trae un token que el backend valida antes de mostrar este formulario. */
function simulateResetLinkClick() {
  ...
  const errorEl = document.getElementById('reset-pass-error');
  errorEl.style.display = 'none';
  errorEl.textContent = '';
}

function confirmNewPasswordFromReset() {
  const nueva = document.getElementById('reset-new-pass').value;
  const confirmacion = document.getElementById('reset-confirm-pass').value;
  const errorEl = document.getElementById('reset-pass-error');
...
function authenticateUser(role) {
  if (role === 'gerente') {
    return { name: 'Marcela Duarte', roleLabel: 'Gerente Comercial', initials: 'MD', role: 'gerente', phone: '+57 310 888 9900', email: 'marcela.duarte@agrodata.com', zone: 'Nacional' };
  } else if (role === 'administrador') {
    return { name: 'Andrés Peña', roleLabel: 'Administrador del Sistema', initials: 'AP', role: 'administrador', phone: '+57 312 700 4411', email: 'andres.pena@agrodata.com', zone: 'Nacional' };
  } else {
    return { name: 'Camila Ríos', roleLabel: 'Asesora comercial (Distribuidor)', initials: 'CR', role: 'asesor', phone: '+57 315 402 8877', email: 'camila.rios@agrodata.com', zone: 'Boyacá - Tolima' };
  }
}
...
function doLogin() {
  ...
  saveState();
  window.location.href = ROLE_HOME[appState.currentUser.role] || 'dashboard.html';
}
...
/* Cambio de contraseña autónomo desde el perfil (SYS-FR-003: cualquier usuario puede
   restablecer su propia contraseña sin depender del administrador). A diferencia del
   flujo de "olvidé mi contraseña" en el login, aquí el usuario ya tiene sesión activa
   y confirma su contraseña actual antes de definir una nueva. */
...
function submitChangePassword() {
  ...
  const confirmacion = document.getElementById('cp-confirm').value;
  const errorEl = document.getElementById('cp-error');
...
function showScreen(id) {
  ...
  if (id === 'scr-reportes-gerente') renderReportesGerente();
  if (id === 'scr-clientes-buscar') { applyClientesRoleView(); renderClientList(); }
  ...
  if (id === 'scr-ordenes') { applyOrdenesRoleView(); renderOrdenes(); }
...
function renderClientList() {
  ...
  if (pageItems.length === 0) {
    ...
    container.innerHTML = pageItems.map((c, i) => `
      <div class="client-row" ${readOnly ? '' : `onclick="openFichaByClientName('${c.nombre.replace(/'/g, "\\'")}')"`} style="${readOnly ? 'cursor:default;' : ''}">
        <img src="${c.img}">
        <div class="cr-info">
          ...
          <div class="cr-meta">
            ...
            ${readOnly ? `<span><i data-lucide="user-round" style="width:12px;height:12px"></i> ${c.distribuidor}</span>` : ''}
          </div>
        </div>
        <div class="cr-right">
          <span class="pill ${pillMap[c.estado] || 'pill-gris'}">${c.estado}</span>
          <span class="cr-code">${c.nit}</span>
          ${readOnly ? '' : `<button class="cr-quick-btn" title="Registro rápido de visita (menos de 60s)" onclick="openQuickVisitModal('${c.nombre.replace(/'/g, "\\'")}', event)"><i data-lucide="zap" style="width:15px;height:15px"></i></button>
...
/* SYS-FR-002: cada rol solo debe ver notificaciones de su propio alcance
   funcional (ver permisosPorRol) y cada una debe apuntar a una pantalla que
   sí esté permitida para ese rol (ver allowedScreensForRole/menus), para no
   repetir el problema de notificaciones fijas iguales para los tres roles. */
const NOTIFICATIONS_BY_ROLE = {
  asesor: [
    { color: 'rojo', title: 'Finca El Paraíso - Cartera vencida hace 12 días', sub: 'Haz clic para ir a Alertas de Cartera', screen: 'scr-alertas' },
    { color: 'amarillo', title: 'Visita pendiente en Finca Villa Marina', sub: 'Haz clic para ir a la Agenda de Visitas', screen: 'scr-visitas' },
    { color: 'verde-acento', title: 'Oportunidad avanzada a propuesta en Hacienda Santa Rita', sub: 'Haz clic para ir al Pipeline Comercial', screen: 'scr-pipeline' }
  ],
  gerente: [
    { color: 'rojo', title: 'Finca El Paraíso - Cartera vencida hace 12 días', sub: 'Haz clic para ir a Alertas Globales', screen: 'scr-alertas-globales' },
    { color: 'amarillo', title: 'Agroindustrias El Roble - Riesgo de inactividad (45 días sin visita)', sub: 'Haz clic para ir a Alertas Globales', screen: 'scr-alertas-globales' },
    { color: 'verde-acento', title: 'Nueva orden de compra registrada por Laura Gómez', sub: 'Haz clic para ir a Órdenes de Compra', screen: 'scr-ordenes' }
  ],
  administrador: [
    { color: 'rojo', title: 'Laura Gómez solicitó restablecimiento de contraseña', sub: 'Haz clic para ir a Usuarios y Roles', screen: 'scr-usuarios' },
    { color: 'amarillo', title: 'Cuenta nueva pendiente de primer acceso', sub: 'Haz clic para ir a Usuarios y Roles', screen: 'scr-usuarios' },
    { color: 'verde-acento', title: 'Camila Ríos - último acceso hace más de 5 días', sub: 'Haz clic para ir a Usuarios y Roles', screen: 'scr-usuarios' }
  ]
};
...
function renderNotifications() {
  ...
  container.innerHTML = items.map(n => `
    <div class="timeline-item" style="cursor:pointer;" onclick="closeModal('modal-notifs'); showScreen('${n.screen}');">
      <div class="ti-dot" style="background:var(--${n.color})"></div>
      <div><div class="ti-title">${n.title}</div><div class="ti-date">${n.sub}</div></div>
    </div>
  `).join('');
  renderIcons();
}
...
/* SYS-FR-025 / SYS-FR-026: el listado y las métricas de desempeño que ve el
   gerente son SOLO de distribuidores (son quienes tienen clientes, visitas,
   oportunidades y ventas). La cuenta de administrador o de otro gerente no
   debe aparecer aquí, porque no gestionan clientes en campo. */
function getDistribuidoresList() {
  return appState.usersList.filter(u => u.rol === 'distribuidor');
}

function renderDashboardGerente() {
  const distribuidores = getDistribuidoresList();
  const tableBody = document.getElementById('tb-performance-asesores');
  tableBody.innerHTML = distribuidores.map(u => `
    <tr>
      <td><b>${u.nombre}</b></td>
      <td>${u.zona}</td>
      <td>${u.clientes}</td>
  ...
  document.getElementById('asesor-distribution-bars').innerHTML = distribuidores.map(u => `
...
/* SYS-FR-025/026/027 (M7 · Reportes y panel gerencial): tabla comparativa de
   distribuidores (visitas, oportunidades, ventas cerradas) con exportación,
   distinta del reporte individual que ve el distribuidor de sí mismo. */
function renderReportesGerente() {
  const distribuidores = getDistribuidoresList();
  const totalClientes = distribuidores.reduce((acc, u) => acc + (u.clientes || 0), 0);
  const totalVisitas = distribuidores.reduce((acc, u) => acc + (u.visitas || 0), 0);
  const totalOportunidades = distribuidores.reduce((acc, u) => acc + (u.oportunidades || 0), 0);
  const totalVentas = distribuidores.reduce((acc, u) => acc + (u.ventas || 0), 0);

  const kpiClientes = document.getElementById('rg-kpi-clientes');
  const kpiVisitas = document.getElementById('rg-kpi-visitas');
  const kpiOportunidades = document.getElementById('rg-kpi-oportunidades');
  const kpiVentas = document.getElementById('rg-kpi-ventas');
  if (kpiClientes) kpiClientes.textContent = totalClientes;
  if (kpiVisitas) kpiVisitas.textContent = totalVisitas;
  if (kpiOportunidades) kpiOportunidades.textContent = totalOportunidades;
  if (kpiVentas) kpiVentas.textContent = totalVentas;

  const body = document.getElementById('rg-distribuidores-body');
  if (body) {
    body.innerHTML = distribuidores.map(u => `
      <tr>
        <td><b>${u.nombre}</b></td>
        <td>${u.zona}</td>
        <td>${u.clientes}</td>
...
const ROL_LABEL = { distribuidor: 'Distribuidor', gerente: 'Gerente', administrador: 'Administrador' };

function renderUsuarios() {
  document.getElementById('usuarios-body').innerHTML = appState.usersList.map((u, i) => `
    <tr>
      <td><b>${u.nombre}</b></td><td>${ROL_LABEL[u.rol] || '—'}</td><td>${u.zona}</td><td>${u.clientes != null ? u.clientes : '—'}</td><td>${u.visitas != null ? u.visitas : '—'}</td><td>${u.acceso}</td>
...
function renderPerms() {
  ...
  `).join('');
  // SYS-FR-002: gerente y distribuidor requieren zona geográfica; el administrador,
  // al ser de alcance técnico y nacional, no la requiere.
  const zoneSection = document.getElementById('nu-zone-section');
  if (zoneSection) zoneSection.style.display = (role === 'administrador') ? 'none' : '';
  renderIcons();
}

function saveNewUser() {
  const name = document.getElementById('nu-name').value;
  const roleValue = document.getElementById('new-user-role').value; // asesor | gerente | administrador
  const rol = roleValue === 'asesor' ? 'distribuidor' : roleValue;
  const zone = (rol === 'administrador') ? 'Nacional' : document.getElementById('nu-zone').value;
  const esDistribuidor = rol === 'distribuidor';
  appState.usersList.push({
    nombre: name, rol, zona: zone,
    clientes: esDistribuidor ? 0 : null, visitas: esDistribuidor ? 0 : null,
    oportunidades: esDistribuidor ? 0 : null, ventas: esDistribuidor ? 0 : null,
    acceso: "Reciente", estado: "Activo"
  });
...
/* SYS-FR-020: el gerente consulta el historial de órdenes (con distribuidor
   visible) pero no registra órdenes nuevas — eso es exclusivo del distribuidor
   que gestiona la relación comercial con el cliente en campo. */
function applyOrdenesRoleView() {
  const role = appState.currentUser ? appState.currentUser.role : 'asesor';
  const isGerente = role === 'gerente';
  const titulo = document.getElementById('ordenes-titulo');
  const subtitulo = document.getElementById('ordenes-subtitulo');
  const btnNueva = document.getElementById('btn-nueva-orden');
  const thDistribuidor = document.getElementById('ordenes-th-distribuidor');
  if (titulo) titulo.textContent = isGerente ? 'Órdenes de Compra — Todos los Distribuidores' : 'Órdenes de Compra';
  if (subtitulo) subtitulo.textContent = isGerente
    ? 'Vista consolidada de solo lectura: historial de órdenes de todos los distribuidores'
    : 'Registra y da seguimiento a los pedidos vinculados a oportunidades cerradas';
  if (btnNueva) btnNueva.style.display = isGerente ? 'none' : 'inline-flex';
  if (thDistribuidor) thDistribuidor.classList.toggle('hidden', !isGerente);
}
...
function renderOrdenes() {
  ...
  body.innerHTML = appState.orders.map(o => `
    <tr>
      ...
      ${isGerente ? `<td>${o.distribuidor || '—'}</td>` : ''}
      <td>${o.producto}</td>
      <td>${o.cantidad}</td>
      <td>${o.precio}</td>
...
function saveNewOrder() {
  ...
  appState.orders.unshift({
    id: Date.now(), clientName, distribuidor: appState.currentUser.name, producto, cantidad, precio, fechaEntrega, estado: 'Pendiente', novedades: []
  });
